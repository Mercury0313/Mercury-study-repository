...
def process_single_patient(patient_id, base_data_dir, stft_subdir="stft_data", window_size=None, stride=None, normalize=True, balance_classes=True):
    ...
    for i in range(len(dataset)):
        ...
        if hasattr(dataset, 'balanced_indices'):
            original_idx = dataset.balanced_indices[i]
        else:
            original_idx = i
...
# 设置路径
    ...
    process_single_patient('chb05',base_data_dir,'stft_data',None,15,normalize=True,balance_classes=True)
    ...
    # patient_ids=['chb03','chb05']
    # merge_patient_samples(
    #     patient_ids=patient_ids,
    #     base_data_dir=base_data_dir,
    #      output_file="training_samples_3_5.npz"
    # )